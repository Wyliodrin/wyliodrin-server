  ...
  def _handle_action_event(self, msg):
    ...
    if self.last_id == 1:
      ...
      if (decoded[b'p'].decode("utf-8") == "myproject" and
          decoded[b'i'] == 1 and
          decoded[b'b'][b'main'].decode("utf-8") != "error"):
      ...
      if (decoded[b'p'].decode("utf-8") == "myproject" and
          decoded[b'i'] == 3 and
          decoded[b'w'][b'a'].decode("utf-8") != "error" and
          decoded[b'w'][b'b'].decode("utf-8") != "error" and
          decoded[b'w'][b'not_a_var'].decode("utf-8") == "error"):
        exit_value = 0
