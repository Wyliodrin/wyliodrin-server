CC = gcc
CFLAGS = -Wall -DERR -DLOG -DSHELLS -DFILES -D_FILE_OFFSET_BITS=64 -pthread -lutil -lfuse

.PHONY: wtalk clean

wtalk: wtalk.o wjson.o wxmpp.o wxmpp_handlers.o shells.o shells_helper.o files.o base64.o libds
	make -C libds
	$(CC) wtalk.o wjson.o wxmpp.o wxmpp_handlers.o shells.o shells_helper.o files.o base64.o libds/*.o -o wtalk \
